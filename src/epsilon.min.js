...
Object.prototype.$define = function (fields) {
	...
	_createClass(Init, [{
		...
		value: function _setValue(name, options, value) {
			if (!this._errors.length) {
				...
				if (!have) object[name] = value;else object.$define(name, descriptor);
			}
		}
	}, {
		key: '_validate',
...
Array.prototype.$define({
	...
	$remove: function $remove(options) {
		...
		if (options.value != undefined) index = this.indexOf(options.value);

		if (index != -1) return this.splice(index, 1);else return false;
	},
